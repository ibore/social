package me.ibore.social.manager;
...
import me.ibore.social.uikit.ActionActivity;
import me.ibore.social.utils.CommonUtils;
import me.ibore.social.utils.FileUtils;
import me.ibore.social.utils.ShareObjCheckUtils;
import me.ibore.social.utils.SocialLogUtils;

import static me.ibore.social.manager.SocialPlatformManager.KEY_ACTION_TYPE;
...
public class SocialShareManager {
    ...
    private static boolean doShare(Context context, @Target.ShareTarget int shareTarget, ShareObj shareObj, OnShareListener onShareListener) {
        ...
        intent.putExtra(KEY_ACTION_TYPE, SocialPlatformManager.ACTION_TYPE_SHARE);
